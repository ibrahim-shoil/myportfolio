...
const PROJECTS = [
  ...
  },
  {
    ...
    name: 'CaptionFlow',
    featured: true,
    description: 'An After Effects ScriptUI panel that imports SRT subtitle files and creates text layers automatically, with one layer per sentence or word.',
  ...
  },
  {
    ...
    problem: 'Animating individual words or characters in After Effects requires manually duplicating and trimming text layers, which is repetitive and slow. It gets even slower with Arabic or mixed-direction text.',
